...
const Shop = () => {
    ...
    return (
        <div className="w-[99vw] min-h-[100vh] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2]">
            {/* main div 1 */}
            <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] ${showFilter ?"h-[45vh]":"h-[8vh]"}  p-[20px] border-r-[1px] border-[#663333] text-[#663333] lg:fixed`}>
            ...
            <div className="lg:pl-[20%] md:py-[10px]">
                <div className=" md:w-[80vw] w-[100vw] p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]">
                    ...
                    <select name="" id="" className="w-[60%] md:w-[200px] h-[50px] px-[10px] text-[#663333] rounded-lg border-[2px] border-black">
